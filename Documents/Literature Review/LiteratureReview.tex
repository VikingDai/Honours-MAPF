...
\subsection{Improving search times}
...
\textbf{Continuous???:} Does the entire search need to be recalculated if a new agent is added into the system (does it look at one batch of units at a time, it cannot handle a continuous stream)
...
\textbf{Online / Offline} Online is when you plan while you move?
} % End no indent
\begin{figure}[H]
\centering
\small
