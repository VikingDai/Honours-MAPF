...
\begin{figure}[H]
	\centering
	\small
%	\smartdiagramset{planet color=orange!60, distance planet-satellite=4cm, bubble node size=5cm}
	\smartdiagram[bubble diagram]{
		\Large Warehouse \\ \Large Automation, Order \\ assignment, Pod \\ Selection, Drive \\ Allocation, Storage Cell \\ Assignment, Charger \\ Allocation, Storage Pod \\ Replenishment, MAPF
	}
...
\begin{itemize}
	...
	\textbf{\item Pruning the search space}
	\textbf{\item Precomputating paths}
\end{itemize}
